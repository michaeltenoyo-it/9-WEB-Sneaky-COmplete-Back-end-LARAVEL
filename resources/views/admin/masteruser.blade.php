                            ...
                            <div class="col s12">
                                <table>
                                    ...
                                    <tbody>
                                        @foreach($user as $u)
                                            <tr>
                                                <td class="tengah">{{$u->username}}</td>
                                                <td class="tengah">{{$u->nama}}</td>
                                                <td class="tengah">{{$u->jenis_user}}</td>
                                                <td class="tengah">{{$u->email}}</td>
                                                @if($u->status_ban == 0)
                                                    <td class="tengah">
                                                        <form action="">
                                                            @csrf
                                                            <input type="hidden" name="id_user" value="{{$u->id_user}}">
                                                            <button class="waves-effect waves-light btn grey lighten-2" style="color: #02075d;font-family: 'Roboto Condensed', sans-serif;font-weight: bold;">Ban</button>
                                                        </form>
                                                    </td>
                                                @else
                                                    <td class="tengah">
                                                        <form action="">
                                                            @csrf
                                                            <input type="hidden" name="id_user" value="{{$u->id_user}}">
                                                            <button class="waves-effect waves-light btn grey lighten-2" style="color: #02075d;font-family: 'Roboto Condensed', sans-serif;font-weight: bold;">UnBan</button>
                                                        </form>    
                                                    </td>
                                                @endif
                                            </tr>
